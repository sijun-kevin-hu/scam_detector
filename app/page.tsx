      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Free AI-powered tool to detect scams, phishing attempts, and fraudulent messages instantly.",
            "featureList": "AI Analysis, Phishing Detection, Risk Scoring, Pattern Recognition"
          })
        }}
      />
